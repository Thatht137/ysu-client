...
const CACHE_POLICIES: Record<string, ProviderCachePolicy> = {
  ...
  "public-classrooms": { ttl: LONG_TTL_MS, persist: true },
  "public-classes": { ttl: LONG_TTL_MS, persist: true },
  "classroom-schedule": { ttl: SHORT_TTL_MS, persist: true },
  "teaching-class-schedule": { ttl: SHORT_TTL_MS, persist: true },
