export const zh = {
  ...
  settings: {
    ...
    minutes: "分钟",
    notifyPermissionDenied: "通知权限被拒绝，请在系统设置中开启",
    notifySessionExpired: "教务系统会话已过期，请打开应用重新登录",
    notifyNewGrade: "新成绩发布",
    notifyNewGradeBody: "{course} 成绩已发布",
    notifyNewExam: "考试安排更新",
    notifyNewExamBody: "{exam} 考试安排已更新",
    serverConfig: "服务器地址",
...
export const en = {
  ...
  settings: {
    ...
    minutes: "minutes",
    notifyPermissionDenied: "Notification permission denied, please enable in system settings",
    notifySessionExpired: "JWXT session expired, please open the app to re-login",
    notifyNewGrade: "New Grade Published",
    notifyNewGradeBody: "{course} grade has been published",
    notifyNewExam: "Exam Schedule Updated",
    notifyNewExamBody: "{exam} exam schedule has been updated",
