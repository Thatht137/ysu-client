export const zh = {
  ...
  classrooms: {
    title: "教室查询",
    description: "默认查看当前时段空教室，也可查询班级或教室课表",
    modes: {
      empty: "空教室",
      class: "班级课表",
      room: "教室课表",
    ...
    section: "节次",
    sectionItem: "第 {section} 节 {time}",
    sectionBadge: "第 {section} 节",
    sectionRange: "第 {start}-{end} 节",
    week: "第 {week} 周",
    weekday: "星期 {day}",
    building: "教学楼",
    allBuildings: "全部教学楼",
    searchRoom: "搜索教室、教学楼或校区",
    searchClass: "搜索班级、学院或专业",
    selectRoom: "选择教室",
    selectClass: "选择班级",
    selectRoomHint: "选择一个教室后查看课表",
    selectClassHint: "选择一个班级后查看课表",
    seats: "{count} 座",
    emptySummary: "{count} 间空教室",
    occupiedSummary: "{count} 间占用",
    noEmptyRooms: "当前筛选条件下暂无空教室",
    noSchedule: "暂无课表数据",
  },
  activity: {
    title: "课程活动",
...
export const en = {
  ...
  update: {
    ...
    errorNoRelease: "No release available for this channel yet.",
  ...
  classrooms: {
    ...
    description: "Shows available rooms by default, with class and room schedules as additional modes",
    modes: {
    ...
    section: "Section",
    sectionItem: "Section {section} {time}",
    ...
    searchRoom: "Search room, building or campus",
    searchClass: "Search class, department or major",
    selectRoom: "Select a room",
    selectClass: "Select a class",
    selectRoomHint: "Select a room to view its schedule",
    selectClassHint: "Select a class to view its schedule",
    seats: "{count} seats",
    emptySummary: "{count} available rooms",
    occupiedSummary: "{count} occupied",
    noEmptyRooms: "No available rooms match the current filters",
